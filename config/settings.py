...
# Allow same-origin requests from the Django-served frontend
...
STRIPE_WEBHOOK_SECRET = config('STRIPE_WEBHOOK_SECRET', default='whsec_your_secret_here')
STRIPE_CURRENCY = 'usd'
...
DEFAULT_FROM_EMAIL = 'noreply@maison.com'
